...
class NewQuestion extends Component {
  ...
  handleSubmit (event) {
    ...
    fetch('http://localhost:5004/question/' + this.state.formData.genre_id +'/'+this.state.formData.qz_id , {
     method: 'POST',
    ...
    return (
      <div className="App">
        <header className="App-header">
          <h1 className="App-title">{'Add New Question' }</h1>
        </header>
        <br/><br/>
        <div className="formContainer">
          <form onSubmit={this.handleSubmit}>
            <div className="form-group">
                ...
                <input type="text" className="form-control" value={this.state.ques} onChange={this.handleQChange} required />
            </div>
            <div className="form-group">
                <input type="checkbox" className="btn" onChange={this.handleO1Change} />
                <label>  &nbsp;&nbsp; Option 1</label>
                <input type="text" className="form-control" value={this.state.opt1} onChange={this.handle1Change} required />
            </div>
            <div className="form-group">
                <input type="checkbox" className="btn" onChange={this.handleO2Change} />
                <label>&nbsp;&nbsp;Option 2</label>
                <input type="text" className="form-control" value={this.state.opt2} onChange={this.handle2Change} required />
            </div>
            <div className="form-group">
                <input type="checkbox" className="btn" onChange={this.handleO3Change} />
                <label>&nbsp;&nbsp;Option 3</label>
                <input type="text" className="form-control" value={this.state.opt3} onChange={this.handle3Change} required />
            </div>
            <div className="form-group">
            <input type="checkbox" className="btn" onChange={this.handleO4Change} />
                <label>&nbsp;&nbsp;Option 4</label>
                <input type="text" className="form-control" value={this.state.opt4} onChange={this.handle4Change} required />
            </div>
